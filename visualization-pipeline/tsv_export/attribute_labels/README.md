# TensorFlow Projector Export - Attribute Labels

This directory contains embeddings exported for visualization in TensorFlow Projector.

## Data Type

**Attribute labels from config_position.attribute_label**

Total embeddings: 452

## Files

- `vectors_2d.tsv` - 2D UMAP coordinates (452 vectors)
- `vectors_3d.tsv` - 3D UMAP coordinates (452 vectors)
